            ...
            <div class="col-md-8">
                <div class="card card-send-msg">
                    <div class="card-header">
                        <h3>වෛද්‍යවරයෙකු(Doctor) හට පණිවිඩයක් යවන්න</h3>
                    </div>
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4 img-col">
                                    <div class="img-area">
                                        <img src="{{asset('img/midwife/doctor.png')}}" alt="doctor" width="110px" height="115px">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="b_table">
                                        <table class="table table-responsive-xl">
                                            @if(count($data['doctors']) > 0)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="content">
                                                        <div class="data-btn">
                                                            <input type='button' class='btn btn-success btn-sm' id='send_doc_msg_btn' data-toggle='modal' href='#msg-model' data-id='{{$doctor->doctor_id}}' value='යවන්න'>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
...
<script>
    ...
    $(document).on("click", "#send_doc_msg_btn", function () {
