...
@section('script')
    ...
    <script>
        $(function() {
            $('.inner-sidebar-menu ul li a.li-height').addClass('drop-active');
        }); 
    </script>
     ...
     <script>
        ...
        $(".download").click(function() {
            ...
            doc.setFontSize(6);
            doc.text(170,293, 'Generated on {{ date("Y, F j") }}');
            doc.setFontSize(8);
            doc.text(10,292, 'This chart was generated by {{ $data["chart_generator"] }} for {{ $data["chart_baby"] }}');
            ...
            doc.save('baby-height-chart.pdf');
        });
